      ...
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription className="text-center">Start your journey to a better score.</CardDescription>
          </CardHeader>
          <form onSubmit={handleRegister}>
            ...
            <CardFooter className="flex flex-col gap-4 mt-2">
              ...
              <div className="text-center text-sm text-[#1F2430]/70">
                ...
                <Link href="/login" className="text-[#E8743B] font-medium hover:underline">
                  Log In
                </Link>
              </div>
            </CardFooter>
